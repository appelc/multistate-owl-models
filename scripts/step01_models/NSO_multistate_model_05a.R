...
## model 05a: p(NOISE + EFFORT) delta(.) psi(STUDY_AREA + NR_SUIT500 + BO_TOTAL) R(STUDY_AREA + NR_SUIT500 + BO_TOTAL)
...
## set model name here
  ...
  modname = '05a_model_posthoc_norm1priors'
