...
## model 05c: p(NOISE + EFFORT) delta(.) psi(STUDY_AREA + NR_SUIT500 + BO_TOTAL) R(STUDY_AREA + NR_SUIT500 + BO_TOTAL)
## post-hoc model for interpretation of covariate effects on psi and R
## with 'uniform' priors: dunif(-5,5)
...
## set model name here
  ...
  modname = '05c_model_posthoc_unifpriors'
